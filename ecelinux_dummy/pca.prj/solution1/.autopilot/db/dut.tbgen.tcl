...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : [], "CDFG" : "dut", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "100"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "101"}
]}
...
set fifoSchedulingInfoList { 
	strm_in_V { fifo_read 33 has_conditional }
	strm_out_V { fifo_write 96 has_conditional }
}
