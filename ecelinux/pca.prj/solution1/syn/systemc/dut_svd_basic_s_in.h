...
#ifndef __dut_svd_basic_s_in_H__
#define __dut_svd_basic_s_in_H__
...
struct dut_svd_basic_s_in_ram : public sc_core::sc_module {
...
sc_core::sc_signal<sc_lv<DataWidth> > q1_t1;
   SC_CTOR(dut_svd_basic_s_in_ram) {
...
dut_svd_basic_s_in_ram* meminst;


SC_CTOR(dut_svd_basic_s_in) {
meminst = new dut_svd_basic_s_in_ram("dut_svd_basic_s_in_ram");
