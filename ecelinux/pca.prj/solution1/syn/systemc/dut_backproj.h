...
struct dut_backproj : public sc_module {
    ...
    sc_signal< sc_lv<20> > indvar_flatten2_reg_112;
    sc_signal< sc_lv<17> > indvar_flatten_reg_123;
    sc_signal< sc_lv<7> > j_reg_134;
    sc_signal< sc_lv<32> > p_03_2_reg_145;
    sc_signal< sc_lv<10> > k_reg_157;
    ...
    sc_signal< sc_lv<20> > indvar_flatten_next2_fu_183_p2;
    sc_signal< sc_lv<20> > indvar_flatten_next2_reg_324;
    sc_signal< sc_lv<10> > k_mid2_fu_245_p3;
    sc_signal< sc_lv<10> > k_mid2_reg_329;
    sc_signal< sc_lv<1> > tmp_mid2_fu_259_p3;
    sc_signal< sc_lv<7> > j_mid2_fu_267_p3;
    sc_signal< sc_lv<7> > j_mid2_reg_342;
    sc_signal< sc_lv<17> > indvar_flatten_next_fu_281_p3;
    sc_signal< sc_lv<17> > indvar_flatten_next_reg_347;
    ...
    sc_signal< sc_lv<10> > k_2_fu_307_p2;
    sc_signal< sc_lv<10> > k_2_reg_371;
    ...
    sc_signal< sc_lv<20> > indvar_flatten2_phi_fu_116_p4;
    sc_signal< sc_lv<17> > indvar_flatten_phi_fu_127_p4;
    sc_signal< sc_lv<7> > j_phi_fu_138_p4;
    sc_signal< sc_lv<32> > p_03_2_phi_fu_149_p4;
    sc_signal< sc_lv<10> > k_phi_fu_161_p4;
    ...
    sc_signal< sc_lv<17> > indvar_flatten_op_fu_275_p2;
