...
#ifndef __dut_matrix_multiply_alt26_sum_mult_H__
#define __dut_matrix_multiply_alt26_sum_mult_H__
...
struct dut_matrix_multiply_alt26_sum_mult_ram : public sc_core::sc_module {
...
sc_core::sc_signal<sc_logic> we1_t1; 
   SC_CTOR(dut_matrix_multiply_alt26_sum_mult_ram) {
...
SC_MODULE(dut_matrix_multiply_alt26_sum_mult) {
...
dut_matrix_multiply_alt26_sum_mult_ram* meminst;


SC_CTOR(dut_matrix_multiply_alt26_sum_mult) {
meminst = new dut_matrix_multiply_alt26_sum_mult_ram("dut_matrix_multiply_alt26_sum_mult_ram");
