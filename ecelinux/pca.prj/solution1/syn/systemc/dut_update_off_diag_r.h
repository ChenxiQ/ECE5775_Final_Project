...
struct dut_update_off_diag_r : public sc_module {
    ...
    sc_signal< sc_lv<1> > exitcond_flatten_reg_139;
    ...
    sc_signal< sc_lv<1> > ap_reg_ppstg_exitcond_flatten_reg_139_pp0_iter1;
    sc_signal< sc_lv<7> > indvar_flatten_reg_75;
    sc_signal< sc_lv<32> > grp_fu_90_p2;
    sc_signal< sc_lv<32> > reg_94;
    sc_signal< bool > ap_sig_221;
    sc_signal< sc_lv<32> > reg_100;
    sc_signal< bool > ap_sig_233;
    sc_signal< sc_lv<32> > reg_105;
    sc_signal< sc_lv<32> > reg_110;
    sc_signal< sc_lv<32> > reg_116;
    sc_signal< sc_lv<32> > grp_fu_86_p2;
    sc_signal< sc_lv<32> > reg_122;
    sc_signal< sc_lv<1> > exitcond_flatten_fu_127_p2;
    sc_signal< sc_lv<7> > indvar_flatten_next_fu_133_p2;
    sc_signal< sc_lv<7> > indvar_flatten_next_reg_143;
    sc_signal< sc_lv<32> > tmp_6_reg_148;
    sc_signal< sc_lv<32> > tmp_7_reg_153;
    sc_signal< sc_lv<32> > tmp_8_reg_158;
    sc_signal< sc_lv<32> > ap_reg_ppstg_tmp_8_reg_158_pp0_iter1;
    sc_signal< sc_lv<32> > tmp_9_reg_163;
    sc_signal< sc_lv<32> > tmp_10_reg_168;
    sc_signal< sc_lv<32> > tmp_11_reg_173;
    sc_signal< sc_lv<32> > tmp_12_reg_178;
    sc_signal< sc_lv<32> > tmp_13_reg_183;
    sc_signal< sc_lv<32> > tmp_14_reg_188;
    sc_signal< sc_lv<32> > tmp_15_reg_193;
    sc_signal< sc_lv<32> > tmp_16_reg_198;
    sc_signal< sc_lv<32> > tmp_17_reg_203;
    sc_signal< sc_lv<32> > tmp_18_reg_208;
    sc_signal< sc_lv<32> > tmp_19_reg_213;
    sc_signal< sc_lv<32> > tmp_3_i2_reg_218;
    sc_signal< sc_lv<32> > tmp_i3_reg_223;
    sc_signal< sc_lv<7> > indvar_flatten_phi_fu_79_p4;
    ...
    void thread_indvar_flatten_phi_fu_79_p4();
