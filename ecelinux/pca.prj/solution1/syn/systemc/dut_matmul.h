...
struct dut_matmul : public sc_module {
    ...
    sc_signal< sc_lv<1> > exitcond_flatten1_reg_364;
    sc_signal< sc_lv<1> > tmp_mid2_reg_382;
    sc_signal< sc_logic > ap_sig_cseq_ST_pp0_stg2_fsm_3;
    sc_signal< bool > ap_sig_65;
    sc_signal< sc_lv<1> > tmp_2_reg_396;
    sc_signal< sc_logic > strm_out_V_blk_n;
    sc_signal< sc_lv<1> > tmp_6_reg_405;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_6_reg_405_pp0_iter1;
    sc_signal< sc_lv<15> > indvar_flatten1_reg_124;
    sc_signal< sc_lv<12> > indvar_flatten_reg_135;
    ...
    sc_signal< sc_lv<15> > indvar_flatten_next1_fu_203_p2;
    sc_signal< sc_lv<15> > indvar_flatten_next1_reg_368;
    sc_signal< sc_lv<7> > k_mid2_fu_265_p3;
    sc_signal< sc_lv<7> > k_mid2_reg_373;
    sc_signal< sc_lv<1> > tmp_mid2_fu_279_p3;
    sc_signal< sc_lv<5> > j_mid2_fu_287_p3;
    sc_signal< sc_lv<5> > j_mid2_reg_386;
    sc_signal< sc_lv<12> > indvar_flatten_next_fu_301_p3;
    sc_signal< sc_lv<12> > indvar_flatten_next_reg_391;
    sc_signal< sc_lv<1> > tmp_2_fu_313_p2;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_2_reg_396_pp0_iter1;
    sc_signal< sc_lv<1> > tmp_6_fu_322_p2;
    sc_signal< sc_lv<7> > k_1_fu_327_p2;
    ...
    sc_signal< sc_lv<15> > indvar_flatten1_phi_fu_128_p4;
    sc_signal< sc_lv<12> > indvar_flatten_phi_fu_139_p4;
    sc_signal< sc_lv<5> > j_phi_fu_150_p4;
    sc_signal< sc_lv<7> > k_phi_fu_161_p4;
    sc_signal< sc_lv<64> > tmp_s_fu_309_p1;
    sc_signal< sc_lv<64> > tmp_3_fu_318_p1;
    ...
    sc_signal< sc_lv<1> > not_exitcond_flatten_fu_235_p2;
    sc_signal< sc_lv<5> > j_mid_fu_215_p3;
    sc_signal< sc_lv<1> > exitcond_mid_fu_247_p2;
    sc_signal< sc_lv<1> > tmp_7_fu_259_p2;
    sc_signal< sc_lv<5> > j_1_fu_253_p2;
    sc_signal< sc_lv<1> > tmp_mid1_fu_273_p2;
    sc_signal< sc_lv<1> > tmp_mid_fu_229_p2;
    sc_signal< sc_lv<12> > indvar_flatten_op_fu_295_p2;
    ...
    void thread_exitcond_mid_fu_247_p2();
    ...
    void thread_indvar_flatten_next_fu_301_p3();
    void thread_indvar_flatten_op_fu_295_p2();
    void thread_indvar_flatten_phi_fu_139_p4();
    void thread_j_1_fu_253_p2();
    void thread_j_mid2_fu_287_p3();
    void thread_j_mid_fu_215_p3();
    void thread_j_phi_fu_150_p4();
    void thread_k_1_fu_327_p2();
    void thread_k_mid2_fu_265_p3();
    void thread_k_phi_fu_161_p4();
    void thread_not_exitcond_flatten_fu_235_p2();
    ...
    void thread_tmp_3_fu_318_p1();
    void thread_tmp_6_fu_322_p2();
    void thread_tmp_7_fu_259_p2();
    void thread_tmp_mid1_fu_273_p2();
    void thread_tmp_mid2_fu_279_p3();
    void thread_tmp_mid_fu_229_p2();
