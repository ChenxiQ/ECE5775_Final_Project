...
`timescale 1 ns / 1 ps
module dut_svd_pairs_s_col1_ram (addr0, ce0, d0, we0, q0, addr1, ce1, d1, we1, q1,  clk);
...
dut_svd_pairs_s_col1_ram dut_svd_pairs_s_col1_ram_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .d0( d0 ),
