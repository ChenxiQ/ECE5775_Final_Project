...
entity dut_svd_basic_s_in_ram is 
    generic(
...
architecture rtl of dut_svd_basic_s_in_ram is 
...
architecture arch of dut_svd_basic_s_in is
    component dut_svd_basic_s_in_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    dut_svd_basic_s_in_ram_U :  component dut_svd_basic_s_in_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
