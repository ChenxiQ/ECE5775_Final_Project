...
architecture behav of dut_calc_angle_float_float_s is 
    ...
    signal p_Result_7_reg_313 : STD_LOGIC_VECTOR (0 downto 0);
    signal storemerge1_fu_235_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_s_fu_243_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_1_fu_251_p3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal p_Result_12_fu_275_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Val2_4_fu_157_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal loc_V_1_fu_161_p4 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal p_Result_10_fu_227_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_Result_11_fu_259_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_Val2_7_fu_271_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    dut_fdiv_32ns_32ns_32_16_U20 : component dut_fdiv_32ns_32ns_32_16
    generic map (
        ID => 1,
        NUM_STAGE => 16,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not((ap_start = ap_const_logic_0)) and not((demorgan_fu_197_p2 = ap_const_lv1_0)))) then 
                cosThetaAdiv2_write_assign_reg_58 <= p_s_fu_243_p3;
            elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not((ap_start = ap_const_logic_0)) and (demorgan_fu_197_p2 = ap_const_lv1_0) and not((demorgan5_fu_221_p2 = ap_const_lv1_0)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not((ap_start = ap_const_logic_0)) and (demorgan_fu_197_p2 = ap_const_lv1_0) and (demorgan5_fu_221_p2 = ap_const_lv1_0))) then
                p_Result_7_reg_313 <= p_Val2_s_fu_142_p1(31 downto 31);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, demorgan_fu_197_p2, demorgan5_fu_221_p2, p_Result_12_fu_275_p3)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_st44_fsm_43 => 
                if (not((ap_const_lv1_0 = p_Result_12_fu_275_p3))) then
    ...
    grp_fu_82_opcode_assign_proc : process(ap_sig_cseq_ST_st44_fsm_43, ap_sig_cseq_ST_st21_fsm_20, p_Result_12_fu_275_p3, ap_sig_cseq_ST_st89_fsm_88)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st44_fsm_43) and not((ap_const_lv1_0 = p_Result_12_fu_275_p3)))) then 
            grp_fu_82_opcode <= ap_const_lv2_1;
        elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st21_fsm_20) or ((ap_const_logic_1 = ap_sig_cseq_ST_st44_fsm_43) and (ap_const_lv1_0 = p_Result_12_fu_275_p3)) or (ap_const_logic_1 = ap_sig_cseq_ST_st89_fsm_88))) then 
    ...
    grp_fu_82_p0_assign_proc : process(reg_121, ap_sig_cseq_ST_st44_fsm_43, ap_sig_cseq_ST_st21_fsm_20, p_Result_12_fu_275_p3, ap_sig_cseq_ST_st89_fsm_88)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st44_fsm_43) and not((ap_const_lv1_0 = p_Result_12_fu_275_p3)))) then 
    ...
    grp_fu_82_p1_assign_proc : process(reg_121, ap_sig_cseq_ST_st44_fsm_43, ap_sig_cseq_ST_st21_fsm_20, p_Result_12_fu_275_p3, ap_sig_cseq_ST_st89_fsm_88)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st44_fsm_43) and not((ap_const_lv1_0 = p_Result_12_fu_275_p3)))) then 
    ...
    grp_fu_96_p0_assign_proc : process(ap_sig_cseq_ST_st1_fsm_0, A_im, reg_128, sinThetaA_int_reg_338, ap_sig_cseq_ST_st49_fsm_48, ap_sig_cseq_ST_st69_fsm_68)
    begin
    ...
    grp_fu_96_p1_assign_proc : process(ap_sig_cseq_ST_st1_fsm_0, A_re, reg_128, sinThetaA_int_reg_338, ap_sig_cseq_ST_st49_fsm_48, ap_sig_cseq_ST_st69_fsm_68)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st69_fsm_68)) then 
    ...
    lhs_V_cast_fu_171_p1 <= std_logic_vector(resize(unsigned(loc_V_1_fu_161_p4),9));
    loc_V_1_fu_161_p4 <= p_Val2_4_fu_157_p1(30 downto 23);
    loc_V_fu_147_p4 <= p_Val2_s_fu_142_p1(30 downto 23);
    notrhs_i1_fu_215_p2 <= "1" when (loc_V_fu_147_p4 = ap_const_lv8_0) else "0";
    notrhs_i_fu_191_p2 <= "1" when (loc_V_1_fu_161_p4 = ap_const_lv8_0) else "0";
    p_1_fu_251_p3 <= 
        ap_const_lv32_3F800000 when (grp_fu_107_p3(0) = '1') else 
        ap_const_lv32_0;
    p_Result_10_fu_227_p3 <= p_Val2_4_fu_157_p1(31 downto 31);
    p_Result_11_fu_259_p3 <= (p_Result_7_reg_313 & ap_const_lv31_3F800000);
    p_Result_12_fu_275_p3 <= p_Val2_7_fu_271_p1(31 downto 31);
    p_Val2_4_fu_157_p1 <= A_im;
    p_Val2_7_fu_271_p1 <= reg_121;
    p_Val2_s_fu_142_p1 <= A_re;
    p_s_fu_243_p3 <= 
    ...
    ret_i_i_i_i_fu_266_p1 <= p_Result_11_fu_259_p3;
    ...
    storemerge1_fu_235_p3 <= 
        ap_const_lv32_BF3504F3 when (p_Result_10_fu_227_p3(0) = '1') else 
