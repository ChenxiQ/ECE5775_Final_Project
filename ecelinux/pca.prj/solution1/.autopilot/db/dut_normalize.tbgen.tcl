...
set C_modelArgList {
	{ X float 32 regular {array 78400 { 2 3 } 1 1 }  }
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1190897", "Max" : "1190897"}
	, {"Name" : "Interval", "Min" : "1190897", "Max" : "1190897"}
]}

set Spec2ImplPortList { 
	X { ap_memory {  { X_address0 mem_address 1 17 }  { X_ce0 mem_ce 1 1 }  { X_we0 mem_we 1 1 }  { X_d0 mem_din 1 32 }  { X_q0 mem_dout 0 32 } } }
