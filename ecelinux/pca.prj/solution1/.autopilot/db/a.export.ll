...
define internal fastcc void @dut_svd_alt([614656 x float]* nocapture %A, [614656 x float]* nocapture %S, [614656 x float]* nocapture %U, [614656 x float]* nocapture %V) {
  %diag_1 = alloca [392 x i32], align 16
  %diag_2 = alloca [392 x i32], align 16
  %S_block_buffer_0_0 = alloca [392 x float], align 16
  %S_block_buffer_0_1 = alloca [392 x float], align 16
  %S_block_buffer_1_0 = alloca [392 x float], align 16
  %S_block_buffer_1_1 = alloca [392 x float], align 16
  %U_block_buffer_0_0 = alloca [392 x float], align 16
  %U_block_buffer_0_1 = alloca [392 x float], align 16
  %U_block_buffer_1_0 = alloca [392 x float], align 16
  %U_block_buffer_1_1 = alloca [392 x float], align 16
  %V_block_buffer_0_0 = alloca [392 x float], align 16
  %V_block_buffer_0_1 = alloca [392 x float], align 16
  %V_block_buffer_1_0 = alloca [392 x float], align 16
  %V_block_buffer_1_1 = alloca [392 x float], align 16
  %S_r_buffer_0 = alloca [307328 x float], align 4
  %S_r_buffer_1 = alloca [307328 x float], align 4
  %S_c_buffer_0 = alloca [307328 x float], align 4
  %S_c_buffer_1 = alloca [307328 x float], align 4
  %U_c_buffer_0 = alloca [307328 x float], align 4
  %U_c_buffer_1 = alloca [307328 x float], align 4
  %V_c_buffer_0 = alloca [307328 x float], align 4
  %V_c_buffer_1 = alloca [307328 x float], align 4
  %J2x2_0_0 = alloca [392 x float], align 16
  %J2x2_0_1 = alloca [392 x float], align 16
  %J2x2_1_0 = alloca [392 x float], align 16
  %J2x2_1_1 = alloca [392 x float], align 16
  %K2x2_0_0 = alloca [392 x float], align 16
  %K2x2_0_1 = alloca [392 x float], align 16
  %K2x2_1_0 = alloca [392 x float], align 16
  %K2x2_1_1 = alloca [392 x float], align 16
  br label %.preheader36

.preheader35.preheader:                           ; preds = %.preheader36
  %bottom_right = alloca i32
  %top_left = alloca i32
  %diag_1_addr = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 1
  %diag_2_addr = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 391
  %diag_1_addr_1 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 391
  %diag_2_addr_1 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 0
  br label %.preheader35

.preheader36:                                     ; preds = %.preheader36.preheader, %0
  %indvar_flatten = phi i20 [ 0, %0 ], [ %indvar_flatten_next, %.preheader36.preheader ]
  %i = phi i10 [ 0, %0 ], [ %tmp_mid2_v, %.preheader36.preheader ]
  %j = phi i10 [ 0, %0 ], [ %j_1, %.preheader36.preheader ]
...
.preheader36.preheader:                           ; preds = %.preheader36
  ...
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 614656, i64 614656, i64 614656)
  %exitcond = icmp eq i10 %j, -240
  %j_mid2 = select i1 %exitcond, i10 0, i10 %j
  %tmp_mid2_v = select i1 %exitcond, i10 %i_1, i10 %i
  %tmp_mid2_cast = zext i10 %tmp_mid2_v to i20
  %tmp = mul i20 %tmp_mid2_cast, 784
  call void (...)* @_ssdm_op_SpecLoopName([10 x i8]* @p_str1805) nounwind
  %tmp_6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([10 x i8]* @p_str1805)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1806) nounwind
  %tmp_6_cast = zext i10 %j_mid2 to i20
  %tmp_17 = add i20 %tmp, %tmp_6_cast
  %tmp_86_cast = zext i20 %tmp_17 to i64
  %A_addr = getelementptr [614656 x float]* %A, i64 0, i64 %tmp_86_cast
  %S_addr = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_86_cast
  %U_addr = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_86_cast
  %V_addr = getelementptr [614656 x float]* %V, i64 0, i64 %tmp_86_cast
  %A_load = load float* %A_addr, align 4
  store float %A_load, float* %S_addr, align 4
  %tmp_7 = icmp eq i10 %tmp_mid2_v, %j_mid2
  ...
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([10 x i8]* @p_str1805, i32 %tmp_6)
...
; <label>:1                                       ; preds = %.preheader35
  ...
  %tmp_18 = call i32 (...)* @_ssdm_op_SpecRegionBegin([11 x i8]* @p_str1807)
  br label %2

; <label>:2                                       ; preds = %3, %1
  %proc = phi i9 [ 0, %1 ], [ %proc_1, %3 ]
  %exitcond5 = icmp eq i9 %proc, -120
  %empty_8 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 392, i64 392, i64 392)
  %proc_1 = add i9 %proc, 1
  br i1 %exitcond5, label %.preheader34, label %3

; <label>:3                                       ; preds = %2
  %tmp_s = call i10 @_ssdm_op_BitConcatenate.i10.i9.i1(i9 %proc, i1 false)
  %tmp_cast = zext i10 %tmp_s to i32
  %tmp_1 = zext i9 %proc to i64
  %diag_1_addr_2 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_1
  store i32 %tmp_cast, i32* %diag_1_addr_2, align 4
  %tmp_2 = or i10 %tmp_s, 1
  %tmp_2_cast = zext i10 %tmp_2 to i32
  %diag_2_addr_2 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_1
...
.preheader34:                                     ; preds = %2, %.preheader34.loopexit
  %step = phi i10 [ %step_1, %.preheader34.loopexit ], [ 0, %2 ]
  %bottom_right_load = load i32* %bottom_right
  %top_left_load = load i32* %top_left
  %exitcond7 = icmp eq i10 %step, -241
  %step_1 = add i10 %step, 1
  br i1 %exitcond7, label %29, label %4

; <label>:4                                       ; preds = %.preheader34
  %empty_9 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 783, i64 783, i64 783)
  %temp_diag = load i32* %diag_1_addr, align 4
  br label %5

; <label>:5                                       ; preds = %6, %4
  %proc1 = phi i9 [ 1, %4 ], [ %proc_2, %6 ]
  %exitcond9 = icmp eq i9 %proc1, -121
  %empty_10 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 390, i64 390, i64 390)
  br i1 %exitcond9, label %7, label %6

; <label>:6                                       ; preds = %5
  %proc_2 = add i9 %proc1, 1
  %tmp_3 = zext i9 %proc_2 to i64
  %diag_1_addr_3 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_3
  %diag_1_load = load i32* %diag_1_addr_3, align 4
  %tmp_4 = zext i9 %proc1 to i64
  %diag_1_addr_4 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_4
...
; <label>:8                                       ; preds = %9, %7
  %proc2 = phi i9 [ -121, %7 ], [ %proc_3, %9 ]
  %tmp_5 = icmp eq i9 %proc2, 0
  %empty_11 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 391, i64 391, i64 391)
  br i1 %tmp_5, label %10, label %9

; <label>:9                                       ; preds = %8
  %proc_3 = add i9 %proc2, -1
  %tmp_10 = zext i9 %proc_3 to i64
  %diag_2_addr_3 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_10
  %diag_2_load_1 = load i32* %diag_2_addr_3, align 4
  %tmp_11 = zext i9 %proc2 to i64
  %diag_2_addr_4 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_11
...
; <label>:11                                      ; preds = %._crit_edge, %10
  ...
  %proc3 = phi i9 [ 0, %10 ], [ %proc_4, %._crit_edge ]
  %exitcond1 = icmp eq i9 %proc3, -120
  %proc_4 = add i9 %proc3, 1
...
; <label>:12                                      ; preds = %11
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1806) nounwind
  %tmp_12 = zext i9 %proc3 to i64
  %diag_1_addr_5 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_12
  %diag_1_load_2 = load i32* %diag_1_addr_5, align 4
  %diag_2_addr_5 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_12
  ...
  %tmp_13 = icmp eq i32 %top_left_1, 784
  %tmp_14 = icmp eq i32 %bottom_right_1, 784
  %or_cond6 = or i1 %tmp_13, %tmp_14
  br i1 %or_cond6, label %._crit_edge, label %13

; <label>:13                                      ; preds = %12
  %tmp_24 = trunc i32 %top_left_1 to i21
  %tmp_25 = mul i21 784, %tmp_24
  %tmp_28 = add i21 %tmp_25, %tmp_24
  %tmp_88_cast = sext i21 %tmp_28 to i64
  %S_addr_1 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_88_cast
  %U_addr_1 = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_88_cast
  %V_addr_1 = getelementptr [614656 x float]* %V, i64 0, i64 %tmp_88_cast
  %S_load = load float* %S_addr_1, align 4
  %S_block_buffer_0_0_addr = getelementptr [392 x float]* %S_block_buffer_0_0, i64 0, i64 %tmp_12
  store float %S_load, float* %S_block_buffer_0_0_addr, align 16
  %U_load = load float* %U_addr_1, align 4
  %U_block_buffer_0_0_addr = getelementptr [392 x float]* %U_block_buffer_0_0, i64 0, i64 %tmp_12
  store float %U_load, float* %U_block_buffer_0_0_addr, align 16
  %V_load = load float* %V_addr_1, align 4
  %V_block_buffer_0_0_addr = getelementptr [392 x float]* %V_block_buffer_0_0, i64 0, i64 %tmp_12
  store float %V_load, float* %V_block_buffer_0_0_addr, align 16
  %tmp_29 = trunc i32 %bottom_right_1 to i21
  %tmp_44 = add i21 %tmp_25, %tmp_29
  %tmp_89_cast = sext i21 %tmp_44 to i64
  %S_addr_2 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_89_cast
  %tmp_45 = mul i21 784, %tmp_29
  %tmp_46 = add i21 %tmp_45, %tmp_24
  %tmp_91_cast = sext i21 %tmp_46 to i64
  %S_addr_3 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_91_cast
  %tmp_53 = add i21 %tmp_45, %tmp_29
  %tmp_92_cast = sext i21 %tmp_53 to i64
  %S_addr_4 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_92_cast
  %U_addr_2 = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_89_cast
  %U_addr_3 = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_91_cast
  %U_addr_4 = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_92_cast
  %V_addr_2 = getelementptr [614656 x float]* %V, i64 0, i64 %tmp_89_cast
  %V_addr_3 = getelementptr [614656 x float]* %V, i64 0, i64 %tmp_91_cast
  %V_addr_4 = getelementptr [614656 x float]* %V, i64 0, i64 %tmp_92_cast
  %S_load_1 = load float* %S_addr_2, align 4
  %S_block_buffer_0_1_addr = getelementptr [392 x float]* %S_block_buffer_0_1, i64 0, i64 %tmp_12
  store float %S_load_1, float* %S_block_buffer_0_1_addr, align 4
  %U_load_1 = load float* %U_addr_2, align 4
  %U_block_buffer_0_1_addr = getelementptr [392 x float]* %U_block_buffer_0_1, i64 0, i64 %tmp_12
  store float %U_load_1, float* %U_block_buffer_0_1_addr, align 4
  %V_load_1 = load float* %V_addr_2, align 4
  %V_block_buffer_0_1_addr = getelementptr [392 x float]* %V_block_buffer_0_1, i64 0, i64 %tmp_12
  store float %V_load_1, float* %V_block_buffer_0_1_addr, align 4
  %S_load_2 = load float* %S_addr_3, align 4
  %S_block_buffer_1_0_addr = getelementptr [392 x float]* %S_block_buffer_1_0, i64 0, i64 %tmp_12
  store float %S_load_2, float* %S_block_buffer_1_0_addr, align 8
  %U_load_2 = load float* %U_addr_3, align 4
  %U_block_buffer_1_0_addr = getelementptr [392 x float]* %U_block_buffer_1_0, i64 0, i64 %tmp_12
  store float %U_load_2, float* %U_block_buffer_1_0_addr, align 8
  %V_load_2 = load float* %V_addr_3, align 4
  %V_block_buffer_1_0_addr = getelementptr [392 x float]* %V_block_buffer_1_0, i64 0, i64 %tmp_12
  store float %V_load_2, float* %V_block_buffer_1_0_addr, align 8
  %S_load_3 = load float* %S_addr_4, align 4
  %S_block_buffer_1_1_addr = getelementptr [392 x float]* %S_block_buffer_1_1, i64 0, i64 %tmp_12
  store float %S_load_3, float* %S_block_buffer_1_1_addr, align 4
  %U_load_3 = load float* %U_addr_4, align 4
  %U_block_buffer_1_1_addr = getelementptr [392 x float]* %U_block_buffer_1_1, i64 0, i64 %tmp_12
  store float %U_load_3, float* %U_block_buffer_1_1_addr, align 4
  %V_load_3 = load float* %V_addr_4, align 4
  %V_block_buffer_1_1_addr = getelementptr [392 x float]* %V_block_buffer_1_1, i64 0, i64 %tmp_12
...
.preheader33:                                     ; preds = %11, %._crit_edge38
  ...
  %proc4 = phi i9 [ %proc_7, %._crit_edge38 ], [ 0, %11 ]
  %exitcond2 = icmp eq i9 %proc4, -120
  %proc_7 = add i9 %proc4, 1
  br i1 %exitcond2, label %.preheader32, label %14

; <label>:14                                      ; preds = %.preheader33
  %empty_14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 392, i64 392, i64 392)
  call void (...)* @_ssdm_op_SpecLoopName([14 x i8]* @p_str1809) nounwind
  %tmp_23 = call i32 (...)* @_ssdm_op_SpecRegionBegin([14 x i8]* @p_str1809)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1806) nounwind
  %tmp_15 = zext i9 %proc4 to i64
  %diag_1_addr_6 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_15
  %diag_1_load_3 = load i32* %diag_1_addr_6, align 4
  %diag_2_addr_6 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_15
  ...
  %tmp_16 = icmp eq i32 %top_left_5, 784
  %tmp_19 = icmp eq i32 %bottom_right_5, 784
  %or_cond7 = or i1 %tmp_16, %tmp_19
  br i1 %or_cond7, label %._crit_edge38, label %_ifconv

_ifconv:                                          ; preds = %14
  %S_block_buffer_0_0_addr_1 = getelementptr [392 x float]* %S_block_buffer_0_0, i64 0, i64 %tmp_15
  %w_in = load float* %S_block_buffer_0_0_addr_1, align 16
  %S_block_buffer_0_1_addr_1 = getelementptr [392 x float]* %S_block_buffer_0_1, i64 0, i64 %tmp_15
  %x_in = load float* %S_block_buffer_0_1_addr_1, align 4
  %S_block_buffer_1_0_addr_1 = getelementptr [392 x float]* %S_block_buffer_1_0, i64 0, i64 %tmp_15
  %y_in = load float* %S_block_buffer_1_0_addr_1, align 8
  %S_block_buffer_1_1_addr_1 = getelementptr [392 x float]* %S_block_buffer_1_1, i64 0, i64 %tmp_15
  ...
  %J2x2_0_0_addr = getelementptr [392 x float]* %J2x2_0_0, i64 0, i64 %tmp_15
  store float %uz_new, float* %J2x2_0_0_addr, align 16
  %J2x2_0_1_addr = getelementptr [392 x float]* %J2x2_0_1, i64 0, i64 %tmp_15
  store float %ux_new, float* %J2x2_0_1_addr, align 4
  %J2x2_1_0_addr = getelementptr [392 x float]* %J2x2_1_0, i64 0, i64 %tmp_15
  store float %uy_int, float* %J2x2_1_0_addr, align 8
  %J2x2_1_1_addr = getelementptr [392 x float]* %J2x2_1_1, i64 0, i64 %tmp_15
  store float %uz_new, float* %J2x2_1_1_addr, align 4
  %K2x2_0_0_addr = getelementptr [392 x float]* %K2x2_0_0, i64 0, i64 %tmp_15
  store float %vw_int_3, float* %K2x2_0_0_addr, align 16
  %K2x2_0_1_addr = getelementptr [392 x float]* %K2x2_0_1, i64 0, i64 %tmp_15
  store float %vy_int_2, float* %K2x2_0_1_addr, align 4
  %K2x2_1_0_addr = getelementptr [392 x float]* %K2x2_1_0, i64 0, i64 %tmp_15
  store float %vx_int, float* %K2x2_1_0_addr, align 8
  %K2x2_1_1_addr = getelementptr [392 x float]* %K2x2_1_1, i64 0, i64 %tmp_15
  store float %vz_int, float* %K2x2_1_1_addr, align 4
  %U_block_buffer_0_0_addr_2 = getelementptr [392 x float]* %U_block_buffer_0_0, i64 0, i64 %tmp_15
  %uw_in = load float* %U_block_buffer_0_0_addr_2, align 16
  %U_block_buffer_0_1_addr_2 = getelementptr [392 x float]* %U_block_buffer_0_1, i64 0, i64 %tmp_15
  %ux_in = load float* %U_block_buffer_0_1_addr_2, align 4
  %U_block_buffer_1_0_addr_2 = getelementptr [392 x float]* %U_block_buffer_1_0, i64 0, i64 %tmp_15
  %uy_in = load float* %U_block_buffer_1_0_addr_2, align 8
  %U_block_buffer_1_1_addr_2 = getelementptr [392 x float]* %U_block_buffer_1_1, i64 0, i64 %tmp_15
  %uz_in = load float* %U_block_buffer_1_1_addr_2, align 4
  %V_block_buffer_0_0_addr_2 = getelementptr [392 x float]* %V_block_buffer_0_0, i64 0, i64 %tmp_15
  %vw_in = load float* %V_block_buffer_0_0_addr_2, align 16
  %V_block_buffer_0_1_addr_2 = getelementptr [392 x float]* %V_block_buffer_0_1, i64 0, i64 %tmp_15
  %vx_in = load float* %V_block_buffer_0_1_addr_2, align 4
  %V_block_buffer_1_0_addr_2 = getelementptr [392 x float]* %V_block_buffer_1_0, i64 0, i64 %tmp_15
  %vy_in = load float* %V_block_buffer_1_0_addr_2, align 8
  %V_block_buffer_1_1_addr_2 = getelementptr [392 x float]* %V_block_buffer_1_1, i64 0, i64 %tmp_15
...
.preheader32:                                     ; preds = %.preheader33, %._crit_edge40
  ...
  %proc5 = phi i9 [ %proc_5, %._crit_edge40 ], [ 0, %.preheader33 ]
  %exitcond4 = icmp eq i9 %proc5, -120
  %proc_5 = add i9 %proc5, 1
  br i1 %exitcond4, label %.preheader30, label %15

; <label>:15                                      ; preds = %.preheader32
  %empty_16 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 392, i64 392, i64 392)
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @p_str1810) nounwind
  %tmp_30 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str1810)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1806) nounwind
  %tmp_20 = zext i9 %proc5 to i64
  %diag_1_addr_7 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_20
  %diag_1_load_4 = load i32* %diag_1_addr_7, align 4
  %diag_2_addr_7 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_20
  ...
  %tmp_21 = icmp eq i32 %top_left_8, 784
  %tmp_26 = icmp eq i32 %bottom_right_8, 784
  %or_cond8 = or i1 %tmp_21, %tmp_26
  br i1 %or_cond8, label %._crit_edge40, label %16

; <label>:16                                      ; preds = %15
  %S_block_buffer_0_0_addr_2 = getelementptr [392 x float]* %S_block_buffer_0_0, i64 0, i64 %tmp_20
  %S_block_buffer_0_0_load = load float* %S_block_buffer_0_0_addr_2, align 16
  %tmp_62 = trunc i32 %top_left_8 to i21
  %tmp_61 = mul i21 784, %tmp_62
  %tmp_68 = add i21 %tmp_61, %tmp_62
  %tmp_94_cast = sext i21 %tmp_68 to i64
  %S_addr_5 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_94_cast
  %U_addr_5 = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_94_cast
  %V_addr_5 = getelementptr [614656 x float]* %V, i64 0, i64 %tmp_94_cast
  store float %S_block_buffer_0_0_load, float* %S_addr_5, align 4
  %U_block_buffer_0_0_addr_1 = getelementptr [392 x float]* %U_block_buffer_0_0, i64 0, i64 %tmp_20
  ...
  %V_block_buffer_0_0_addr_1 = getelementptr [392 x float]* %V_block_buffer_0_0, i64 0, i64 %tmp_20
  ...
  %S_block_buffer_0_1_addr_2 = getelementptr [392 x float]* %S_block_buffer_0_1, i64 0, i64 %tmp_20
  %S_block_buffer_0_1_load = load float* %S_block_buffer_0_1_addr_2, align 4
  %tmp_69 = trunc i32 %bottom_right_8 to i21
  %tmp_70 = add i21 %tmp_61, %tmp_69
  %tmp_95_cast = sext i21 %tmp_70 to i64
  %S_addr_6 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_95_cast
  %tmp_75 = mul i21 784, %tmp_69
  %tmp_82 = add i21 %tmp_75, %tmp_62
  %tmp_97_cast = sext i21 %tmp_82 to i64
  %S_addr_7 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_97_cast
  %tmp_83 = add i21 %tmp_75, %tmp_69
  %tmp_98_cast = sext i21 %tmp_83 to i64
  %S_addr_8 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_98_cast
  %U_addr_6 = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_95_cast
  %U_addr_7 = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_97_cast
  %U_addr_8 = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_98_cast
  %V_addr_6 = getelementptr [614656 x float]* %V, i64 0, i64 %tmp_95_cast
  %V_addr_7 = getelementptr [614656 x float]* %V, i64 0, i64 %tmp_97_cast
  %V_addr_8 = getelementptr [614656 x float]* %V, i64 0, i64 %tmp_98_cast
  store float %S_block_buffer_0_1_load, float* %S_addr_6, align 4
  %U_block_buffer_0_1_addr_1 = getelementptr [392 x float]* %U_block_buffer_0_1, i64 0, i64 %tmp_20
  ...
  %V_block_buffer_0_1_addr_1 = getelementptr [392 x float]* %V_block_buffer_0_1, i64 0, i64 %tmp_20
  ...
  %S_block_buffer_1_0_addr_2 = getelementptr [392 x float]* %S_block_buffer_1_0, i64 0, i64 %tmp_20
  ...
  %U_block_buffer_1_0_addr_1 = getelementptr [392 x float]* %U_block_buffer_1_0, i64 0, i64 %tmp_20
  ...
  %V_block_buffer_1_0_addr_1 = getelementptr [392 x float]* %V_block_buffer_1_0, i64 0, i64 %tmp_20
  ...
  %S_block_buffer_1_1_addr_2 = getelementptr [392 x float]* %S_block_buffer_1_1, i64 0, i64 %tmp_20
  ...
  %U_block_buffer_1_1_addr_1 = getelementptr [392 x float]* %U_block_buffer_1_1, i64 0, i64 %tmp_20
  ...
  %V_block_buffer_1_1_addr_1 = getelementptr [392 x float]* %V_block_buffer_1_1, i64 0, i64 %tmp_20
...
.preheader30:                                     ; preds = %.preheader32, %._crit_edge43
  %indvar_flatten8 = phi i19 [ %indvar_flatten_next9, %._crit_edge43 ], [ 0, %.preheader32 ]
  %proc6 = phi i9 [ %tmp_27_mid2, %._crit_edge43 ], [ 0, %.preheader32 ]
  ...
  %i7 = phi i10 [ %i_2, %._crit_edge43 ], [ 0, %.preheader32 ]
  %tmp_27 = zext i9 %proc6 to i64
  %diag_1_addr_8 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_27
  %diag_1_load_5 = load i32* %diag_1_addr_8, align 4
  %diag_2_addr_8 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_27
  ...
  %exitcond_flatten1 = icmp eq i19 %indvar_flatten8, -216960
  %indvar_flatten_next9 = add i19 %indvar_flatten8, 1
...
; <label>:18                                      ; preds = %17
  %tmp_87 = trunc i32 %idx2_idx1_i461_top_left_6 to i21
  %tmp_45_cast1 = zext i10 %i7_mid2 to i19
  %tmp_45_cast = zext i10 %i7_mid2 to i21
  %tmp_88 = mul i21 784, %tmp_45_cast
  %tmp_89 = add i21 %tmp_87, %tmp_88
  %tmp_102_cast = sext i21 %tmp_89 to i64
  %S_addr_9 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_102_cast
  %U_addr_9 = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_102_cast
  %V_addr_9 = getelementptr [614656 x float]* %V, i64 0, i64 %tmp_102_cast
  %tmp_90 = add i19 %tmp_45_cast1, %tmp_60
  %tmp_103_cast = zext i19 %tmp_90 to i64
  %S_c_buffer_0_addr = getelementptr [307328 x float]* %S_c_buffer_0, i64 0, i64 %tmp_103_cast
  %S_c_buffer_1_addr = getelementptr [307328 x float]* %S_c_buffer_1, i64 0, i64 %tmp_103_cast
  %U_c_buffer_0_addr = getelementptr [307328 x float]* %U_c_buffer_0, i64 0, i64 %tmp_103_cast
  %V_c_buffer_1_addr = getelementptr [307328 x float]* %V_c_buffer_1, i64 0, i64 %tmp_103_cast
  %U_c_buffer_1_addr = getelementptr [307328 x float]* %U_c_buffer_1, i64 0, i64 %tmp_103_cast
  %V_c_buffer_0_addr = getelementptr [307328 x float]* %V_c_buffer_0, i64 0, i64 %tmp_103_cast
  ...
  %tmp_91 = trunc i32 %bottom_right_write_assign_i to i21
  %tmp_92 = add i21 %tmp_91, %tmp_88
  %tmp_104_cast = sext i21 %tmp_92 to i64
  %S_addr_10 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_104_cast
  %U_addr_10 = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_104_cast
  %V_addr_10 = getelementptr [614656 x float]* %V, i64 0, i64 %tmp_104_cast
...
._crit_edge43:                                    ; preds = %._crit_edge45, %.preheader31
  %i_2 = add i10 %i7_mid2, 1
  br label %.preheader30

.preheader31:                                     ; preds = %.preheader30
  %proc_6 = add i9 %proc6, 1
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @L_svd_rd_off_r_str)
  %empty_19 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 307328, i64 307328, i64 307328)
  %exitcond6 = icmp eq i10 %i7, -240
  %i7_mid2 = select i1 %exitcond6, i10 0, i10 %i7
  %tmp_27_mid1 = zext i9 %proc_6 to i64
  %tmp_27_mid2 = select i1 %exitcond6, i9 %proc_6, i9 %proc6
  %tmp_27_mid2_cast = zext i9 %tmp_27_mid2 to i19
  %tmp_60 = mul i19 %tmp_27_mid2_cast, 784
  %diag_1_addr_9 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_27_mid1
  %diag_1_load_6 = load i32* %diag_1_addr_9, align 4
  %diag_2_addr_9 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_27_mid1
  ...
  %tmp_34 = icmp eq i32 %idx2_idx1_i461_top_left_6, 784
  %tmp_37 = icmp eq i32 %bottom_right_write_assign_i, 784
  %or_cond9 = or i1 %tmp_34, %tmp_37
  br i1 %or_cond9, label %._crit_edge43, label %17

.preheader28:                                     ; preds = %.preheader30, %._crit_edge48
  %indvar_flatten1 = phi i19 [ %indvar_flatten_next1, %._crit_edge48 ], [ 0, %.preheader30 ]
  %proc8 = phi i9 [ %tmp_31_mid2, %._crit_edge48 ], [ 0, %.preheader30 ]
  ...
  %off_row = phi i10 [ %off_row_1, %._crit_edge48 ], [ 0, %.preheader30 ]
  %tmp_31 = zext i9 %proc8 to i64
  %diag_1_addr_10 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_31
  %diag_1_load_7 = load i32* %diag_1_addr_10, align 4
  %diag_2_addr_10 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_31
  ...
  %exitcond_flatten2 = icmp eq i19 %indvar_flatten1, -216960
  %indvar_flatten_next1 = add i19 %indvar_flatten1, 1
...
; <label>:20                                      ; preds = %19
  %tmp_53_cast = zext i10 %off_row_mid2 to i19
  %tmp_94 = add i19 %tmp_84, %tmp_53_cast
  %tmp_106_cast = zext i19 %tmp_94 to i64
  %S_c_buffer_0_addr_1 = getelementptr [307328 x float]* %S_c_buffer_0, i64 0, i64 %tmp_106_cast
  %S_c_buffer_1_addr_1 = getelementptr [307328 x float]* %S_c_buffer_1, i64 0, i64 %tmp_106_cast
  %U_c_buffer_0_addr_1 = getelementptr [307328 x float]* %U_c_buffer_0, i64 0, i64 %tmp_106_cast
  %V_c_buffer_1_addr_1 = getelementptr [307328 x float]* %V_c_buffer_1, i64 0, i64 %tmp_106_cast
  %U_c_buffer_1_addr_1 = getelementptr [307328 x float]* %U_c_buffer_1, i64 0, i64 %tmp_106_cast
  %V_c_buffer_0_addr_1 = getelementptr [307328 x float]* %V_c_buffer_0, i64 0, i64 %tmp_106_cast
...
._crit_edge48:                                    ; preds = %._crit_edge50, %.preheader29
  %off_row_1 = add i10 %off_row_mid2, 1
  br label %.preheader28

.preheader29:                                     ; preds = %.preheader28
  %proc_8 = add i9 %proc8, 1
  call void (...)* @_ssdm_op_SpecLoopName([17 x i8]* @L_svd_calc_off_r_str)
  %empty_21 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 307328, i64 307328, i64 307328)
  %exitcond8 = icmp eq i10 %off_row, -240
  %off_row_mid2 = select i1 %exitcond8, i10 0, i10 %off_row
  %tmp_31_mid1 = zext i9 %proc_8 to i64
  %tmp_31_mid2 = select i1 %exitcond8, i9 %proc_8, i9 %proc8
  %tmp_31_mid2_cast1 = zext i9 %tmp_31_mid2 to i19
  %tmp_31_mid2_cast = zext i9 %tmp_31_mid2 to i64
  %tmp_84 = mul i19 %tmp_31_mid2_cast1, 784
  %diag_1_addr_11 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_31_mid1
  %diag_1_load_8 = load i32* %diag_1_addr_11, align 4
  %diag_2_addr_11 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_31_mid1
  %diag_2_load_8 = load i32* %diag_2_addr_11, align 4
  %K2x2_0_0_addr_1 = getelementptr [392 x float]* %K2x2_0_0, i64 0, i64 %tmp_31_mid2_cast
  %K2x2_0_0_load = load float* %K2x2_0_0_addr_1, align 4
  %K2x2_0_1_addr_1 = getelementptr [392 x float]* %K2x2_0_1, i64 0, i64 %tmp_31_mid2_cast
  %K2x2_0_1_load = load float* %K2x2_0_1_addr_1, align 4
  %K2x2_1_0_addr_1 = getelementptr [392 x float]* %K2x2_1_0, i64 0, i64 %tmp_31_mid2_cast
  %K2x2_1_0_load = load float* %K2x2_1_0_addr_1, align 4
  %K2x2_1_1_addr_1 = getelementptr [392 x float]* %K2x2_1_1, i64 0, i64 %tmp_31_mid2_cast
  %K2x2_1_1_load = load float* %K2x2_1_1_addr_1, align 4
  %J2x2_0_0_addr_1 = getelementptr [392 x float]* %J2x2_0_0, i64 0, i64 %tmp_31_mid2_cast
  %J2x2_0_0_load = load float* %J2x2_0_0_addr_1, align 4
  %J2x2_0_1_addr_1 = getelementptr [392 x float]* %J2x2_0_1, i64 0, i64 %tmp_31_mid2_cast
  %J2x2_0_1_load = load float* %J2x2_0_1_addr_1, align 4
  %J2x2_1_0_addr_1 = getelementptr [392 x float]* %J2x2_1_0, i64 0, i64 %tmp_31_mid2_cast
  %J2x2_1_0_load = load float* %J2x2_1_0_addr_1, align 4
  %J2x2_1_1_addr_1 = getelementptr [392 x float]* %J2x2_1_1, i64 0, i64 %tmp_31_mid2_cast
  ...
  %tmp_38 = icmp eq i32 %idx2_idx1_i466_top_left_9, 784
  %tmp_43 = icmp eq i32 %bottom_right_write_assign_i1, 784
  %or_cond10 = or i1 %tmp_38, %tmp_43
  br i1 %or_cond10, label %._crit_edge48, label %19

.preheader26:                                     ; preds = %.preheader28, %._crit_edge53
  %indvar_flatten2 = phi i19 [ %indvar_flatten_next2, %._crit_edge53 ], [ 0, %.preheader28 ]
  %proc9 = phi i9 [ %tmp_35_mid2, %._crit_edge53 ], [ 0, %.preheader28 ]
  ...
  %i2 = phi i10 [ %i_3, %._crit_edge53 ], [ 0, %.preheader28 ]
  %tmp_35 = zext i9 %proc9 to i64
  %diag_1_addr_12 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_35
  %diag_1_load_9 = load i32* %diag_1_addr_12, align 4
  %diag_2_addr_12 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_35
  ...
  %exitcond_flatten3 = icmp eq i19 %indvar_flatten2, -216960
  %indvar_flatten_next2 = add i19 %indvar_flatten2, 1
...
; <label>:22                                      ; preds = %21
  %tmp_60_cast1 = zext i10 %i2_mid2 to i19
  %tmp_60_cast = zext i10 %i2_mid2 to i21
  %tmp_96 = mul i21 784, %tmp_60_cast
  %tmp_97 = add i19 %tmp_60_cast1, %tmp_86
  %tmp_109_cast = zext i19 %tmp_97 to i64
  %S_c_buffer_0_addr_2 = getelementptr [307328 x float]* %S_c_buffer_0, i64 0, i64 %tmp_109_cast
  %S_c_buffer_1_addr_2 = getelementptr [307328 x float]* %S_c_buffer_1, i64 0, i64 %tmp_109_cast
  %U_c_buffer_0_addr_2 = getelementptr [307328 x float]* %U_c_buffer_0, i64 0, i64 %tmp_109_cast
  %V_c_buffer_1_addr_2 = getelementptr [307328 x float]* %V_c_buffer_1, i64 0, i64 %tmp_109_cast
  %U_c_buffer_1_addr_2 = getelementptr [307328 x float]* %U_c_buffer_1, i64 0, i64 %tmp_109_cast
  %V_c_buffer_0_addr_2 = getelementptr [307328 x float]* %V_c_buffer_0, i64 0, i64 %tmp_109_cast
  %S_c_buffer_0_load = load float* %S_c_buffer_0_addr_2, align 8
  %tmp_98 = trunc i32 %idx2_idx1_i489_top_left_s to i21
  %tmp_99 = add i21 %tmp_98, %tmp_96
  %tmp_110_cast = sext i21 %tmp_99 to i64
  %S_addr_11 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_110_cast
  %U_addr_11 = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_110_cast
  %V_addr_11 = getelementptr [614656 x float]* %V, i64 0, i64 %tmp_110_cast
  ...
  %tmp_100 = trunc i32 %bottom_right_write_assign_i2 to i21
  %tmp_101 = add i21 %tmp_100, %tmp_96
  %tmp_111_cast = sext i21 %tmp_101 to i64
  %S_addr_12 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_111_cast
  %U_addr_12 = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_111_cast
  %V_addr_12 = getelementptr [614656 x float]* %V, i64 0, i64 %tmp_111_cast
...
._crit_edge53:                                    ; preds = %._crit_edge55, %.preheader27
  %i_3 = add i10 %i2_mid2, 1
  br label %.preheader26

.preheader27:                                     ; preds = %.preheader26
  %proc_9 = add i9 %proc9, 1
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @L_svd_wb_off_r_str)
  %empty_23 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 307328, i64 307328, i64 307328)
  %exitcond10 = icmp eq i10 %i2, -240
  %i2_mid2 = select i1 %exitcond10, i10 0, i10 %i2
  %tmp_35_mid1 = zext i9 %proc_9 to i64
  %tmp_35_mid2 = select i1 %exitcond10, i9 %proc_9, i9 %proc9
  %tmp_35_mid2_cast = zext i9 %tmp_35_mid2 to i19
  %tmp_86 = mul i19 %tmp_35_mid2_cast, 784
  %diag_1_addr_13 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_35_mid1
  %diag_1_load_10 = load i32* %diag_1_addr_13, align 4
  %diag_2_addr_13 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_35_mid1
  ...
  %tmp_47 = icmp eq i32 %idx2_idx1_i489_top_left_s, 784
  %tmp_52 = icmp eq i32 %bottom_right_write_assign_i2, 784
  %or_cond11 = or i1 %tmp_47, %tmp_52
  br i1 %or_cond11, label %._crit_edge53, label %21

.preheader24:                                     ; preds = %.preheader26, %._crit_edge58
  %indvar_flatten3 = phi i19 [ %indvar_flatten_next3, %._crit_edge58 ], [ 0, %.preheader26 ]
  %proc7 = phi i9 [ %tmp_41_mid2, %._crit_edge58 ], [ 0, %.preheader26 ]
  ...
  %i3 = phi i10 [ %i_4, %._crit_edge58 ], [ 0, %.preheader26 ]
  %tmp_41 = zext i9 %proc7 to i64
  %diag_1_addr_14 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_41
  %diag_1_load_11 = load i32* %diag_1_addr_14, align 4
  %diag_2_addr_14 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_41
  ...
  %exitcond_flatten4 = icmp eq i19 %indvar_flatten3, -216960
  %indvar_flatten_next3 = add i19 %indvar_flatten3, 1
...
; <label>:24                                      ; preds = %23
  %tmp_68_cast1 = zext i10 %i3_mid2 to i21
  %tmp_68_cast = zext i10 %i3_mid2 to i19
  %tmp_103 = add i19 %tmp_68_cast, %tmp_93
  %tmp_113_cast = zext i19 %tmp_103 to i64
  %S_r_buffer_0_addr = getelementptr [307328 x float]* %S_r_buffer_0, i64 0, i64 %tmp_113_cast
  %S_r_buffer_1_addr = getelementptr [307328 x float]* %S_r_buffer_1, i64 0, i64 %tmp_113_cast
  %tmp_104 = trunc i32 %idx2_idx1_i494_top_left_s to i21
  %tmp_105 = mul i21 784, %tmp_104
  %tmp_106 = add i21 %tmp_68_cast1, %tmp_105
  %tmp_115_cast = sext i21 %tmp_106 to i64
  %S_addr_13 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_115_cast
  %S_load_6 = load float* %S_addr_13, align 4
  store float %S_load_6, float* %S_r_buffer_0_addr, align 4
  %tmp_107 = trunc i32 %bottom_right_write_assign_i3 to i21
  %tmp_108 = mul i21 784, %tmp_107
  %tmp_109 = add i21 %tmp_68_cast1, %tmp_108
  %tmp_117_cast = sext i21 %tmp_109 to i64
  %S_addr_14 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_117_cast
...
._crit_edge58:                                    ; preds = %._crit_edge60, %.preheader25
  %i_4 = add i10 %i3_mid2, 1
  br label %.preheader24

.preheader25:                                     ; preds = %.preheader24
  %proc_12 = add i9 %proc7, 1
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @L_svd_rd_off_c_str)
  %empty_25 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 307328, i64 307328, i64 307328)
  %exitcond11 = icmp eq i10 %i3, -240
  %i3_mid2 = select i1 %exitcond11, i10 0, i10 %i3
  %tmp_41_mid1 = zext i9 %proc_12 to i64
  %tmp_41_mid2 = select i1 %exitcond11, i9 %proc_12, i9 %proc7
  %tmp_41_mid2_cast = zext i9 %tmp_41_mid2 to i19
  %tmp_93 = mul i19 %tmp_41_mid2_cast, 784
  %diag_1_addr_15 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_41_mid1
  %diag_1_load_12 = load i32* %diag_1_addr_15, align 4
  %diag_2_addr_15 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_41_mid1
  ...
  %tmp_54 = icmp eq i32 %idx2_idx1_i494_top_left_s, 784
  %tmp_59 = icmp eq i32 %bottom_right_write_assign_i3, 784
  %or_cond12 = or i1 %tmp_54, %tmp_59
  br i1 %or_cond12, label %._crit_edge58, label %23

.preheader22:                                     ; preds = %.preheader24, %._crit_edge63
  %indvar_flatten4 = phi i19 [ %indvar_flatten_next4, %._crit_edge63 ], [ 0, %.preheader24 ]
  %proc10 = phi i9 [ %tmp_50_mid2, %._crit_edge63 ], [ 0, %.preheader24 ]
  ...
  %off_col = phi i10 [ %off_col_1, %._crit_edge63 ], [ 0, %.preheader24 ]
  %tmp_50 = zext i9 %proc10 to i64
  %diag_1_addr_16 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_50
  %diag_1_load_13 = load i32* %diag_1_addr_16, align 4
  %diag_2_addr_16 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_50
  ...
  %exitcond_flatten5 = icmp eq i19 %indvar_flatten4, -216960
  %indvar_flatten_next4 = add i19 %indvar_flatten4, 1
...
; <label>:26                                      ; preds = %25
  %tmp_75_cast = zext i10 %off_col_mid2 to i19
  %tmp_110 = add i19 %tmp_95, %tmp_75_cast
  %tmp_119_cast = zext i19 %tmp_110 to i64
  %S_r_buffer_0_addr_1 = getelementptr [307328 x float]* %S_r_buffer_0, i64 0, i64 %tmp_119_cast
  %S_r_buffer_1_addr_1 = getelementptr [307328 x float]* %S_r_buffer_1, i64 0, i64 %tmp_119_cast
...
._crit_edge63:                                    ; preds = %._crit_edge65, %.preheader23
  %off_col_1 = add i10 %off_col_mid2, 1
  br label %.preheader22

.preheader23:                                     ; preds = %.preheader22
  %proc_14 = add i9 %proc10, 1
  call void (...)* @_ssdm_op_SpecLoopName([17 x i8]* @L_svd_calc_off_c_str)
  %empty_27 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 307328, i64 307328, i64 307328)
  %exitcond12 = icmp eq i10 %off_col, -240
  %off_col_mid2 = select i1 %exitcond12, i10 0, i10 %off_col
  %tmp_50_mid1 = zext i9 %proc_14 to i64
  %tmp_50_mid2 = select i1 %exitcond12, i9 %proc_14, i9 %proc10
  %tmp_50_mid2_cast1 = zext i9 %tmp_50_mid2 to i19
  %tmp_50_mid2_cast = zext i9 %tmp_50_mid2 to i64
  %tmp_95 = mul i19 %tmp_50_mid2_cast1, 784
  %diag_1_addr_17 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_50_mid1
  %diag_1_load_14 = load i32* %diag_1_addr_17, align 4
  %diag_2_addr_17 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_50_mid1
  %diag_2_load_14 = load i32* %diag_2_addr_17, align 4
  %J2x2_0_0_addr_2 = getelementptr [392 x float]* %J2x2_0_0, i64 0, i64 %tmp_50_mid2_cast
  %J2x2_0_0_load_1 = load float* %J2x2_0_0_addr_2, align 4
  %J2x2_0_1_addr_2 = getelementptr [392 x float]* %J2x2_0_1, i64 0, i64 %tmp_50_mid2_cast
  %J2x2_0_1_load_1 = load float* %J2x2_0_1_addr_2, align 4
  %J2x2_1_0_addr_2 = getelementptr [392 x float]* %J2x2_1_0, i64 0, i64 %tmp_50_mid2_cast
  %J2x2_1_0_load_1 = load float* %J2x2_1_0_addr_2, align 4
  %J2x2_1_1_addr_2 = getelementptr [392 x float]* %J2x2_1_1, i64 0, i64 %tmp_50_mid2_cast
  ...
  %tmp_63 = icmp eq i32 %idx2_idx1_i499_top_left_s, 784
  %tmp_67 = icmp eq i32 %bottom_right_write_assign_i4, 784
  %or_cond13 = or i1 %tmp_63, %tmp_67
  br i1 %or_cond13, label %._crit_edge63, label %25

.preheader:                                       ; preds = %.preheader22, %._crit_edge68
  %indvar_flatten5 = phi i19 [ %indvar_flatten_next5, %._crit_edge68 ], [ 0, %.preheader22 ]
  %proc11 = phi i9 [ %tmp_57_mid2, %._crit_edge68 ], [ 0, %.preheader22 ]
  ...
  %i4 = phi i10 [ %i_5, %._crit_edge68 ], [ 0, %.preheader22 ]
  %tmp_57 = zext i9 %proc11 to i64
  %diag_1_addr_18 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_57
  %diag_1_load_15 = load i32* %diag_1_addr_18, align 4
  %diag_2_addr_18 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_57
  ...
  %exitcond_flatten6 = icmp eq i19 %indvar_flatten5, -216960
  %indvar_flatten_next5 = add i19 %indvar_flatten5, 1
...
; <label>:28                                      ; preds = %27
  %tmp_82_cast1 = zext i10 %i4_mid2 to i21
  %tmp_82_cast = zext i10 %i4_mid2 to i19
  %tmp_111 = add i19 %tmp_82_cast, %tmp_102
  %tmp_120_cast = zext i19 %tmp_111 to i64
  %S_r_buffer_0_addr_2 = getelementptr [307328 x float]* %S_r_buffer_0, i64 0, i64 %tmp_120_cast
  %S_r_buffer_1_addr_2 = getelementptr [307328 x float]* %S_r_buffer_1, i64 0, i64 %tmp_120_cast
  %S_r_buffer_0_load = load float* %S_r_buffer_0_addr_2, align 4
  %tmp_112 = trunc i32 %idx2_idx1_i510_top_left_s to i21
  %tmp_113 = mul i21 784, %tmp_112
  %tmp_114 = add i21 %tmp_82_cast1, %tmp_113
  %tmp_122_cast = sext i21 %tmp_114 to i64
  %S_addr_15 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_122_cast
  store float %S_r_buffer_0_load, float* %S_addr_15, align 4
  %S_r_buffer_1_load = load float* %S_r_buffer_1_addr_2, align 4
  %tmp_115 = trunc i32 %bottom_right_write_assign_i5 to i21
  %tmp_116 = mul i21 784, %tmp_115
  %tmp_117 = add i21 %tmp_82_cast1, %tmp_116
  %tmp_124_cast = sext i21 %tmp_117 to i64
  %S_addr_16 = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_124_cast
...
._crit_edge68:                                    ; preds = %._crit_edge70, %.preheader21
  %i_5 = add i10 %i4_mid2, 1
  br label %.preheader

.preheader21:                                     ; preds = %.preheader
  %proc_15 = add i9 %proc11, 1
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @L_svd_wb_off_c_str)
  %empty_29 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 307328, i64 307328, i64 307328)
  %exitcond13 = icmp eq i10 %i4, -240
  %i4_mid2 = select i1 %exitcond13, i10 0, i10 %i4
  %tmp_57_mid1 = zext i9 %proc_15 to i64
  %tmp_57_mid2 = select i1 %exitcond13, i9 %proc_15, i9 %proc11
  %tmp_57_mid2_cast = zext i9 %tmp_57_mid2 to i19
  %tmp_102 = mul i19 %tmp_57_mid2_cast, 784
  %diag_1_addr_19 = getelementptr inbounds [392 x i32]* %diag_1, i64 0, i64 %tmp_57_mid1
  %diag_1_load_16 = load i32* %diag_1_addr_19, align 4
  %diag_2_addr_19 = getelementptr inbounds [392 x i32]* %diag_2, i64 0, i64 %tmp_57_mid1
  ...
  %tmp_71 = icmp eq i32 %idx2_idx1_i510_top_left_s, 784
  %tmp_74 = icmp eq i32 %bottom_right_write_assign_i5, 784
  %or_cond14 = or i1 %tmp_71, %tmp_74
  br i1 %or_cond14, label %._crit_edge68, label %27

; <label>:29                                      ; preds = %.preheader34
  %empty_30 = call i32 (...)* @_ssdm_op_SpecRegionEnd([11 x i8]* @p_str1807, i32 %tmp_18)
  br label %.preheader35
...
.loopexit5:                                       ; preds = %.preheader14, %0
  %i = phi i10 [ 0, %0 ], [ %i_6, %.preheader14 ]
  %phi_mul = phi i20 [ 0, %0 ], [ %next_mul, %.preheader14 ]
  %next_mul = add i20 %phi_mul, 784
  %exitcond11 = icmp eq i10 %i, -240
  %empty_32 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 784, i64 784, i64 784)
  %i_6 = add i10 %i, 1
  br i1 %exitcond11, label %2, label %.preheader14

.preheader14:                                     ; preds = %.loopexit5, %1
  %j = phi i10 [ %j_2, %1 ], [ 0, %.loopexit5 ]
  %exitcond10 = icmp eq i10 %j, -240
  %empty_33 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 784, i64 784, i64 784)
  %j_2 = add i10 %j, 1
  br i1 %exitcond10, label %.loopexit5, label %1

; <label>:1                                       ; preds = %.preheader14
  %tmp = call float @_ssdm_op_Read.ap_fifo.volatile.floatP(float* %strm_in_V)
  %tmp_86_cast = zext i10 %j to i20
  %tmp_s = add i20 %phi_mul, %tmp_86_cast
  %tmp_127_cast = zext i20 %tmp_s to i64
  %XXT_addr = getelementptr [614656 x float]* %XXT, i64 0, i64 %tmp_127_cast
  store float %tmp, float* %XXT_addr, align 4
  br label %.preheader14

; <label>:2                                       ; preds = %.loopexit5
  call fastcc void @dut_svd_alt([614656 x float]* %XXT, [614656 x float]* %S, [614656 x float]* %U, [614656 x float]* %V)
  br label %.loopexit

.loopexit:                                        ; preds = %.preheader13, %2
  %i1 = phi i10 [ 0, %2 ], [ %i_7, %.preheader13 ]
  %phi_mul1 = phi i20 [ 0, %2 ], [ %next_mul2, %.preheader13 ]
  %next_mul2 = add i20 %phi_mul1, 784
  %exitcond9 = icmp eq i10 %i1, -240
  %empty_34 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 784, i64 784, i64 784)
  %i_7 = add i10 %i1, 1
  br i1 %exitcond9, label %.preheader12, label %.preheader13

.preheader13:                                     ; preds = %.loopexit, %3
  %j2 = phi i10 [ %j_3, %3 ], [ 0, %.loopexit ]
  %exitcond8 = icmp eq i10 %j2, -240
...
; <label>:3                                       ; preds = %.preheader13
  %tmp_88_cast = zext i10 %j2 to i20
  %tmp_118 = add i20 %phi_mul1, %tmp_88_cast
  %tmp_129_cast = zext i20 %tmp_118 to i64
  %S_addr = getelementptr [614656 x float]* %S, i64 0, i64 %tmp_129_cast
  %tmp_116 = load float* %S_addr, align 4
  call void @_ssdm_op_Write.ap_fifo.volatile.floatP(float* %strm_out_V, float %tmp_116)
  br label %.preheader13

.preheader12:                                     ; preds = %.preheader, %.loopexit
  %i3 = phi i10 [ 0, %.loopexit ], [ %i_8, %.preheader ]
  %phi_mul3 = phi i20 [ 0, %.loopexit ], [ %next_mul4, %.preheader ]
  %next_mul4 = add i20 %phi_mul3, 784
  %exitcond7 = icmp eq i10 %i3, -240
  %empty_36 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 784, i64 784, i64 784)
  %i_8 = add i10 %i3, 1
  br i1 %exitcond7, label %5, label %.preheader

.preheader:                                       ; preds = %.preheader12, %4
  %j4 = phi i10 [ %j_4, %4 ], [ 0, %.preheader12 ]
  %exitcond = icmp eq i10 %j4, -240
  %empty_37 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 784, i64 784, i64 784)
  %j_4 = add i10 %j4, 1
  br i1 %exitcond, label %.preheader12, label %4

; <label>:4                                       ; preds = %.preheader
  %tmp_89_cast = zext i10 %j4 to i20
  %tmp_119 = add i20 %phi_mul3, %tmp_89_cast
  %tmp_131_cast = zext i20 %tmp_119 to i64
  %U_addr = getelementptr [614656 x float]* %U, i64 0, i64 %tmp_131_cast
  %tmp_117 = load float* %U_addr, align 4
...
entry:
  ...
  %empty_42 = zext i31 %1 to i32
  %empty_43 = shl i32 %empty, 31
...
entry:
  ...
  %empty_45 = zext i1 %1 to i10
  %empty_46 = shl i10 %empty, 1
...
!16 = metadata !{metadata !"kernel_arg_type", metadata !"const float [784]*", metadata !"float [784]*", metadata !"float [784]*", metadata !"float [784]*"}
