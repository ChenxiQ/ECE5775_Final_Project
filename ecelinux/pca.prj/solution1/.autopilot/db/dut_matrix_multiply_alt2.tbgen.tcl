set moduleName dut_matrix_multiply_alt2
...
set isOneStateSeq 0
set C_modelName {dut_matrix_multiply_alt2}
set C_modelType { void 0 }
set C_modelArgList {
	{ A float 32 regular {array 15680 { 1 3 } 1 1 }  }
	{ B float 32 regular {array 156800 { 1 3 } 1 1 }  }
	{ C float 32 regular {array 4000 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"], "CDFG" : "dut_matrix_multiply_alt2", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
	...
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.dut_fadd_32ns_32ns_32_5_full_dsp_U48", "Parent" : "0", "Child" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.dut_fmul_32ns_32ns_32_4_max_dsp_U49", "Parent" : "0", "Child" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.dut_mac_muladd_5ns_9ns_8ns_13_1_U50", "Parent" : "0", "Child" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.dut_mac_muladd_10ns_9ns_8ns_18_1_U51", "Parent" : "0", "Child" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.dut_mac_muladd_5ns_11ns_10ns_15_1_U52", "Parent" : "0", "Child" : []}]}

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3136012", "Max" : "3136012"}
	, {"Name" : "Interval", "Min" : "3136012", "Max" : "3136012"}
]}
...
set Spec2ImplPortList { 
	...
	C { ap_memory {  { C_address0 mem_address 1 12 }  { C_ce0 mem_ce 1 1 }  { C_we0 mem_we 1 1 }  { C_d0 mem_din 1 32 } } }
}
